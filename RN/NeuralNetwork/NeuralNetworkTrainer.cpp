...
namespace BPN
{
    ...
    void NetworkTrainer::Train( TrainingData const& trainingData )
    {
		...
		debug_con << " Neural Network Training Starting: ";
		debug_con << "==========================================================================";
		...
		while ( ( m_trainingSetAccuracy < m_desiredAccuracy && m_generalizationSetAccuracy < m_desiredAccuracy ) && m_currentEpoch < m_maxEpochs )
        {
			...
			debug_con << "Epoch :" << m_currentEpoch << "";
			debug_con << " Training Set Accuracy:" << m_trainingSetAccuracy << "%, MSE: " << m_trainingSetMSE << "";
			debug_con << " Generalization Set Accuracy:" << m_generalizationSetAccuracy << "%, MSE: " << m_generalizationSetMSE << "";
